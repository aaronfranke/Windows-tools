...
echo This tool will automatically download many programs and patches.
echo.
...
if "%version%" == "5.2" echo.
if "%version%" == "5.2" echo Windows XP x64 edition is no longer supported. Only the 32-bit version 
if "%version%" == "5.2" echo is supported with Unofficial SP4 until April 2019. 
if "%version%" == "5.2" echo.
if "%version%" == "5.2" echo Please consider switching to Lubuntu.
